# Generated by Django 4.2.30 on 2026-06-17 12:09

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import django.utils.timezone
import pyf_auth.models
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_campus', models.CharField(blank=True, max_length=64, null=True)),
            ...
            managers=[
                ('objects', pyf_auth.models.UserManager()),
            ],
        ),
    ]
